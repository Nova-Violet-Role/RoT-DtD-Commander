...
- `node lib/list.mjs controls`: 44 run, 0 failing
- `node lib/starlist.mjs controls`: 33 run, 0 failing
- 131 commands, 22 skills, 5 agents; checked 158; 1433 declarations; 46 gate-chain commands
