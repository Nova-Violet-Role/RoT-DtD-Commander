...
export const FAMILIES = [
  ...
  { id: 'asking', name: 'Asking and deciding', rep: 'ask-me-questions', color: '8e44ad',
    ...
    members: ['ask-me-questions', 'ask-me-many-questions', 'ask-me-everything', 'ask-me-katabasis', 'ask-me-maelstrom', 'brainstorm-meta-clear-section'], patterns: [/^coin-flip/] },
  ...
  { id: 'repository', name: 'Repository', rep: 'git-gh-amplification', color: '9b59b6',
    ...
    members: ['git-gh-amplification', 'git-gh-matrix-scala', 'git-gh-Companion', 'repo-git-scalar', 'repo-creativity-askingstorm'] },
