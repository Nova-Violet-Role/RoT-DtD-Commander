---
description: Invoke create-hooks-dtd for a hook whose payload is data and whose guard is tripped before it ships
allowed-tools: Skill(create-hooks-dtd)
---
...
- `invocation`: one Skill call to create-hooks-dtd
</grammar_map>
