---
description: Invoke setup-ralph-dtd to set up the Ralph Wiggum loop with a backpressure check that was watched failing
argument-hint: "[directory or requirements]"
allowed-tools: Skill(setup-ralph-dtd)
---
...
Invoke the setup-ralph skill for: <quoted trust="cdata" source="user-args">$ARGUMENTS</quoted>
