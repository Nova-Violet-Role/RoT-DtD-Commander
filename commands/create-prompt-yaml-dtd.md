...
<!-- end subset cc-ask -->
  ...
  <!ENTITY LAW.PROMPT.1 "The schematic of this command is yaml, fixed in its DOCTYPE; the file it writes is a YAML document and every syntax in it comes from a SCHEMA.yaml.* entity (LAW.SCHEMA.1).">
