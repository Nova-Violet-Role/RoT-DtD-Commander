---
description: Invoke create-slash-commands-dtd for a command with a DOCTYPE, a trust boundary and a grammar map
argument-hint: [command description or requirements]
allowed-tools: Skill(create-slash-commands-dtd)
---
...
Invoke the create-slash-commands skill for: <quoted trust="cdata" source="user-args">$ARGUMENTS</quoted>
...
- `invocation`: one Skill call to create-slash-commands-dtd
</grammar_map>
