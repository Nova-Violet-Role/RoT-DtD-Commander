...
<!-- end subset cc-rot -->
  ...
  <!ATTLIST packet from (nova|violet|antivenom|venom|carnage|chroma|soleil|eidolon|claude) #REQUIRED to (nova|violet|antivenom|venom|carnage|chroma|soleil|eidolon|claude) #REQUIRED instruction (EXEC|SYNC|HALT|QUERY) #REQUIRED urgency (HIGH|MEDIUM|LOW) #REQUIRED>
