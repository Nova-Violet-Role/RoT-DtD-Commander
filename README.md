...
[![Contract](https://img.shields.io/badge/contract_audit-1436_declarations%2C_0_unused-27ae60?style=flat-square)](#-what-is-claimed-and-the-instrument-behind-each-claim)
...
| every declaration in the subsets and the Adiutor contract is used by a source, every law prefix is numbered densely, and every law family is read in ascending order | `node checker/contract-audit.mjs`: `1436 declarations, 0 unused, 0 law gaps`, and the three planted controls | 2026-09-03 |
