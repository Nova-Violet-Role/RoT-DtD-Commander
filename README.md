...
[![Checker](https://img.shields.io/badge/checked-171_files%2C_0_failed-27ae60?style=flat-square)](#-what-is-claimed-and-the-instrument-behind-each-claim)
[![Contract](https://img.shields.io/badge/contract_audit-2058_declarations%2C_0_unused-27ae60?style=flat-square)](#-what-is-claimed-and-the-instrument-behind-each-claim)
...
143 commands, in the families the command index lists, every
...
<!-- rdc-index:begin -->
*143 commands in 17 families, 23 skills, 5 agents. Every family opens below; the rest of this page is folded.*


_This index is generated by `node checker/readme-index.mjs` from the resolved tree; `--check` in the gate refuses a README that disagrees with it. 143 commands in 17 families, 23 skills, 5 agents._
...
[![Asking and deciding](https://img.shields.io/badge/%E2%9D%93_Asking_and_deciding-9-8e44ad?style=flat-square)](#family-asking)
...
[![Repository](https://img.shields.io/badge/%F0%9F%90%99_Repository-4-9b59b6?style=flat-square)](#family-repository)
...
<details>
<summary><b>❓ Asking and deciding</b> · 9 commands</summary>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="docs/family-asking-and-deciding-dark.svg" />
  <img alt="Asking and deciding: 9 commands with the call each one takes" src="docs/family-asking-and-deciding.svg" />
</picture>
...
<details>
<summary><b>🐙 Repository</b> · 4 commands</summary>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="docs/family-repository-dark.svg" />
  <img alt="Repository: 4 commands with the call each one takes" src="docs/family-repository.svg" />
</picture>
...
For search and filters across all 171 entries at once, open
...
**❓ Asking and deciding** · 9 commands
...
<!-- rdc-claims:machine-readable — the same rows the plate above draws, kept as text
     ...
     |---|---|---|
     | 143 commands, 23 skills, 5 agents carry a DOCTYPE | `rdc list` | 2026-09-07 |
     | every source passes rules C1 to C16 | `rdc check`: `checked 171  failed 0` | 2026-09-07 |
     | the committed resolved tree equals a fresh build | `rdc build --check`: `310 targets, 0 drifted, 0 failing` | 2026-09-07 |
     ...
     | every declaration in the subsets and the Adiutor contract is used by a source, every law prefix is numbered densely, and every law family is read in ascending order | `node checker/contract-audit.mjs`: `2058 declarations, 0 unused, 0 law gaps`, and the three planted controls | 2026-09-07 |
     ...
     | every subset the repository declares is installed, and a version the recognizer disputes is refused | `rdc doctor` row `subsets`: `35 subsets, every one installed` (run against your own installation, not in CI); `node checker/release-notes.mjs --versions`: the recognised class and version printed beside the manifests | every push |
