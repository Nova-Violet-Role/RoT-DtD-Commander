...
[![Controls](https://img.shields.io/badge/guards_tripped_on_purpose-31_%2B_35-27ae60?style=flat-square)](#-verify-it-yourself)
...
<!-- rdc-verify:machine-readable — the same commands the plate above draws, kept as
     ...
     bash checker/checker-controls.sh      # M0 to M32: seven mutations refused, one under INCLUDE and the untouched file pass, then twenty-six scorer and runner controls
