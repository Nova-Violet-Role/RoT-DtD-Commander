...
[![Checker](https://img.shields.io/badge/checked-151_files%2C_0_failed-27ae60?style=flat-square)](#-what-is-claimed-and-the-instrument-behind-each-claim)
[![Contract](https://img.shields.io/badge/contract_audit-1321_declarations%2C_0_unused-27ae60?style=flat-square)](#-what-is-claimed-and-the-instrument-behind-each-claim)
...
<!-- rdc-index:begin -->
_This index is generated by `node checker/readme-index.mjs` from the resolved tree; `--check` in the gate refuses a README that disagrees with it. 123 commands in 13 families, 23 skills, 5 agents._
...
| `amplify-codebase-dtd` | The growth ladder and the release recognizer behind /amplify-codebase-dtd, /enhance-codebase-dtd and /overhaul-codebase-dtd. |
...
|---|---|---|
| 123 commands, 23 skills, 5 agents carry a DOCTYPE | `rdc list` | 2026-09-03 |
| every source passes rules C1 to C14 | `rdc check`: `checked 151  failed 0` | 2026-09-03 |
...
| the growth ladder is fifteen verbs partitioned into three bands with no overlap and no gap, a possibility keeps one id across runs, a refusal is never re-offered, and a release is named and never taken | `node lib/amplify.mjs controls`: `17 run, 0 failing`, among them a ceiling tripped on purpose and the generated ladder held against the DTD | every push |
