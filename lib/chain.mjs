...
export function resolve(key, root = ROOT) {
  ...
  return { key, exists: true, root: rootEl, hands_to: hands, band, needsArtifact, handsArtifact, hasArgs, bytes: t.length };
}
...
export function controls() {
  ...
  // The two enumerations the DTD declares are the two the code produces, in
  // both directions: every why has a producer above, every takes appears.
