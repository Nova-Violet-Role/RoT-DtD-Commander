...
2. Round 1 of 3: ask ASK.SKILL.1 to ASK.SKILL.4 as one AskUserQuestion call, four options each plus Other; render the round.
3. Present the gate; on more, round 2 of 3 with ASK.SKILL.5, ASK.SKILL.6, ASK.LICENSE.1 and ASK.FORM.1 (multi-select); on more again, round 3 of 3 with ASK.SKILL.7 to ASK.SKILL.10; on add or impactful, take the answer and present the gate again; on start, proceed with every unasked question at its first option, listed under Assumptions Made.
