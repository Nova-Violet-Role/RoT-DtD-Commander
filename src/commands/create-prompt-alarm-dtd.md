...
<!DOCTYPE prompt_forge [
  ...
  <!ENTITY LAW.PROMPT.1 "The schematic of this command is alarm, fixed in its DOCTYPE; the file it writes is the alarm shape, Markdown with the house callout vocabulary and every syntax in it comes from a SCHEMA.alarm.* entity (LAW.SCHEMA.1).">
  <!ENTITY LAW.PROMPT.2 "The sections are those of SCHEMA.prompt.sections, rendered in that order; the argument words are embedded through SCHEMA.alarm.reference and SCHEMA.alarm.literal in the class the intake chose (LAW.SCHEMA.2, LAW.SCHEMA.3).">
  ...
  <!ENTITY LAW.PROMPT.4 "The file takes the extension SCHEMA.ext.alarm, carries the chosen SPDX identifier where its form allows a comment, and passes every cc-form guard of its kind before it is reported (LAW.SCHEMA.4).">
