...
description: "DTD-aware skill auditor. Use when auditing, reviewing or evaluating a *-dtd SKILL.md and its directory: checks the DOCTYPE against the body in both directions (rules C1 to C15), the declared_grammar, the record declarations and the laws, then YAML, structure, progressive disclosure and content quality. MUST BE USED when the user asks to audit a -dtd skill."
